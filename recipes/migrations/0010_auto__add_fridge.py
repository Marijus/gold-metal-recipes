...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Fridge'
        db.create_table(u'recipes_fridge', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'recipes', ['Fridge'])

        # Adding M2M table for field products on 'Fridge'
        m2m_table_name = db.shorten_name(u'recipes_fridge_products')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('fridge', models.ForeignKey(orm[u'recipes.fridge'], null=False)),
            ('productmeasurement', models.ForeignKey(orm[u'recipes.productmeasurement'], null=False))
        ))
        db.create_unique(m2m_table_name, ['fridge_id', 'productmeasurement_id'])


    def backwards(self, orm):
        # Deleting model 'Fridge'
        db.delete_table(u'recipes_fridge')

        # Removing M2M table for field products on 'Fridge'
        db.delete_table(db.shorten_name(u'recipes_fridge_products'))
