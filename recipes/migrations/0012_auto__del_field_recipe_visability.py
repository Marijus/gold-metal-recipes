...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Recipe.visability'
        db.delete_column(u'recipes_recipe', 'visability')


    def backwards(self, orm):
        # Adding field 'Recipe.visability'
        db.add_column(u'recipes_recipe', 'visability',
    ...
    models = {
        ...
        u'recipes.recipe': {
            ...
            'products': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['recipes.Product']", 'through': u"orm['recipes.Ingridient']", 'symmetrical': 'False'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '250'})
        }
    }
