...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'recipes_recipe', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='slug wsup', unique=True, max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recipe.slug'
        db.delete_column(u'recipes_recipe', 'slug')
