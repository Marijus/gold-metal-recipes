...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recipe.overall_rating'
        db.add_column(u'recipes_recipe', 'overall_rating',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recipe.overall_rating'
        db.delete_column(u'recipes_recipe', 'overall_rating')
