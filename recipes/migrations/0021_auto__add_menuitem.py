...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'recipes_menuitem', (
            ...
            ('portions', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal(u'recipes', ['MenuItem'])

        # Removing M2M table for field recipes on 'Menu'
        db.delete_table(db.shorten_name(u'recipes_menu_recipes'))


    def backwards(self, orm):
        # Deleting model 'MenuItem'
        db.delete_table(u'recipes_menuitem')

        # Adding M2M table for field recipes on 'Menu'
        m2m_table_name = db.shorten_name(u'recipes_menu_recipes')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('menu', models.ForeignKey(orm[u'recipes.menu'], null=False)),
            ('recipe', models.ForeignKey(orm[u'recipes.recipe'], null=False))
        ))
        db.create_unique(m2m_table_name, ['menu_id', 'recipe_id'])
    ...
    models = {
        ...
        u'recipes.menuitem': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'menu': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['recipes.Menu']"}),
            'portions': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'recipe': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['recipes.Recipe']"})
        },
        u'recipes.product': {
